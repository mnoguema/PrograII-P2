...
public interface InActivitatList {
     ...
     * Carregar la llista d'activitats. Llegeix linies d'un fitxer de text pla,
        on cada linia representa una activitat amb un nom realitzada un dia, en un interval
        horari i amb un preu determinat.
     ...
     */
    public static LlistaActivitats carregaLlistaActivitats(String filepath) {
